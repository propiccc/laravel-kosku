...
function Login() {
    ...
    return (
        <div className={`h-screen flex justify-center items-center `}>
            ...
            />
            <section className="bg-gray-700 p-6 text-center w-[400px] shadow-md rounded-xl max-h-fit border-[1px] border-white animate-background ">
                ...
                >
                    <div className="flex flex-col mb-10">
                        <input
                            type="text"
                            id="username"
                            className="focus:outline-none focus:border-b-blue-500 bg-transparent border-b-[2px] p-4 text-white transition-colors duration-200 text-lg placeholder-white"
