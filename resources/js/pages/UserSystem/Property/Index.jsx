                        ...
                        <div className="text-black bg-white hover:bg-gray-50 rounded-b-md p-4 h-[246px] w-full flex flex-col">
                            ...
                            <div className="h-[80px] max-w-[300px]">
                                <p className="text-black max-h-[80px] text-ellipsis text-sm overflow-hidden after:content-['...']">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus eum deserunt odio autem quos architecto, illo veniam error ab harum, blanditiis maiores. Minima ab sapiente magni non fugiat! Illo voluptatibus culpa recusandae placeat ducimus mollitia eveniet assumenda. Assumenda, reiciendis? Delectus magni deleniti commodi, eos quam nemo aperiam tenetur ipsam accusantium, rerum deserunt iusto error itaque, temporibus saepe quas quia. Consequatur. 
                                </p>
                            </div>
