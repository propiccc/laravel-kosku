...
function Instagram() {
  ...
  console.log('data instagram', DataInstagram);
  return (
              ...
              <tr className={`h-14 hover:bg-gray-200`}>
                ...
                <td>
                  <div className="flex justify-center gap-x-1">
                    <button className='border-[2px] text-sm border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold py-2 px-2 rounded-lg transition-all duration-300 active:scale-95'>GET DATA</button>
                  </div>
                </td>
              </tr>
            ))}
