  ...
  return (
    <>
      <div className="bg-white pt-6 pb-2 px-6 rounded-t-lg">
        <span className='text-2xl font-semibold'>Visi Misi</span>
      ...
      <div className="bg-white rounded-b-lg px-6 pb-6 shadow-lg">
        <div className="flex gap-x-2">
          <div className="w-full">
            ...
            <textarea name="" id="visi" className='w-full border-[1px] border-black items-center rounded-lg p-2'></textarea>
          </div>
          <div className="w-full">
            <label htmlFor="misi" className='font-semibold text-xl'>Misi :  <span className='text-red-700 font-semibold'>*</span></label>
            <textarea name="" id="misi" className='w-full border-[1px] border-black items-center rounded-lg p-2'></textarea>
          </div>
        </div>
        <div className="h-[2px] w-full bg-gray-300 my-4"></div>
