            ...
            <div className="flex flex-wrap gap-x-1 gap-y-2">
                <div className="flex flex-col w-full">
                    ...
                    <input
                        id="name"
                        type="text"
                        className="border-[1px] border-solid rounded-md border-black focus:outline-blue-500 px-2 py-1"
                        name="name"
                        value={Data.name}
                ...
                <div className="flex flex-col w-full">
                    ...
                    <input
                        ...
                        value={edit?.password_confirmation}
                        onChange={HandleChange}
                    />
                </div>
                <div className="h-[2px] w-full bg-gray-200 my-3"></div>
